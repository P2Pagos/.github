...
flowchart LR
  ...
  subgraph walletWrap[" "]
    wallet["/wallet"]
    walletPlatform["(iOS и Android)"]
    seedMono["сид-фраза"]
    seedMarket["сид-фраза"]
    seedTeam["сид-фраза / xpub"]
  end

  mono["/mono"]
  monoBtcpay["Сервер BTCPay"]

  subgraph docker["Docker"]
    marketplace["/marketplace"]
    marketBtcpay["Сервер BTCPay"]
  end

  team["/team"]
  otherWallet["/wallet"]

  builtMarket["построено на"]
  builtTeam["построено на"]
