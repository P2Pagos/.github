...
- [Organization profile and localizations](https://github.com/P2Pagos/.github/tree/main/profile)

- [Organization Discussions](https://github.com/orgs/P2Pagos/discussions)  
  There is no content yet, but it is open for visitor inquiries.

- [BTCPay Server wallets setup](https://github.com/P2Pagos/.github/wiki/BTCPay-wallets-setup)  
